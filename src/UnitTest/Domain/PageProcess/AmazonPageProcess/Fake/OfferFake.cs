...
namespace WonderfullOffers.Tests.UnitTest.Domain.PageProcess.AmazonPageProcess.Fake;

public static class OfferFake
{
    public static List<AmazonOffer> GetOffersFake()
    => new()
        {
            new()
            {
